...
<script type="text/ecmascript-6">
  import { getOrgList, getPositionList } from '@/api/approve'
  ...
  export default {
    ...
    methods: {
      ...
      _getPositionList () {
        let obj = Object.assign({}, this.param, {'stationType': this.stationType})
        if (obj.ParentOrgId.length > 0) {
          obj.ParentOrgId = obj.ParentOrgId[obj.ParentOrgId.length - 1].replace(/"/g, '')
        }
