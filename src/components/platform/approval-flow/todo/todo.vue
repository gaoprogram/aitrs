        ...
        <div :class="['table',!tableArr.length? 'not_found': '']" v-loading="loading">
          <el-table
            ...
            <el-table-column
              ...
              <template slot-scope="scope">
                <!-- <el-badge is-dot class="item"> -->
                  <el-button class="share-button" icon="" style="padding:5px" :type="_securityClass(scope.row.SecurityClass)" size="mini" @click="editSecurityClassLevel(scope)" v-text="_securityLevel(scope.row.SecurityClass)"></el-button>
                <!-- </el-badge>      -->
