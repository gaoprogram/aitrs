...
//   import MenuTreeCmp from '@/base/Manage-common-cmp/MenuTree-cmp'
  ...
  export default {
    ...
    methods: {
        ...
        // 删除列表
        _batchDelSysUserGroup(){
            this.loading = true
            batchDelSysUserGroup(JSON.stringify(this.currentRow)).then(res => {
                this.loading = false
